...
#==============================================================
# Módulo 3 (Functions and Packages)
#==============================================================
# Familiar Functions
#===============================================
...
phi = radians(12)
TravelDistance = r * phi
dist = TravelDistance

# Print out dist
print(dist)
#===============================================
# Diferent ways of importing
#===============================================
#Suppose you want to use the function inv(),
#which is in the linalg subpackage of the scipy package.
#Youwant to be able to use this function as follows:
...
#The "as" word allows you to create a local name for the function
#you're importing: <code>inv()</code>, is now available as "my_inv()".
